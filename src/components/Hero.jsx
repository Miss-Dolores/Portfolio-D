  ...
  return (
    <section className="hero bg-gray-800 text-white py-20 text-center text-sm md:text-lg">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <button className="mt-6 px-6 py-3 bg-white text-green-600 rounded hover:bg-gray-100">
        Contactez-moi
        </button> </div>
        <div className="w-full overflow-hidden flex justify-center items-center my-4"> 
          <img src="image.jpg" alt="photo" className="border-10 border-green-600/20 w-70 h-100 md:w-120 lg:h-140 xl:h-160 object-cover object-center"
